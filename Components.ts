...
const FirstWelcome = () => (
    html`
        <section>
            <p>The Spurs are a magnet for basketball talent. Their phenomenal streak of over 20 consecutive playoff appearences and 5 championships in that time is due to their ability to identify and utilize valuable players. Their propensity to identify NBA talent overseas, find undrafted players that can contribute, and assimilate aging stars looking for one last chance at the trophy has meant quite a few peculiar and surprising alums adorned the Silver & Black. Some you probably forgot about. There are also players that fit the Spurs' ethos so well you could <em>swear</em> they've called the AT&T Center home. How well do you know your last twenty years of Spurs history? Can you correctly identify whether or not these players played for the San Antonio Spurs?</p>
